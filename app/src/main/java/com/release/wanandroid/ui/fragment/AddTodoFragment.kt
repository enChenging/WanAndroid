...
import com.release.wanandroid.ext.formatCurrentDate
import com.release.wanandroid.ext.showToast
import com.release.wanandroid.ext.stringToCalendar
import com.release.wanandroid.mvp.contract.AddTodoContract
import com.release.wanandroid.mvp.model.bean.TodoBean
import com.release.wanandroid.mvp.presenter.AddTodoPresenter
...
class AddTodoFragment : BaseMvpFragment<AddTodoContract.View, AddTodoContract.Presenter>(), AddTodoContract.View {
    ...
    override fun initLayoutID(): Int = R.layout.fragment_add_todo
